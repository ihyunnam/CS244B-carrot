...
/* This code simulates a network under censorship where some websites are blocked.
   Carrot interposes on GET request and forwards it to multiple machines 
   in series, which may or may not have access to the requested website.
   Socket is closed after the first valid response is received.
