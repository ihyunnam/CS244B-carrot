...
const uint32_t TableStruct_request_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::CarrotFileResponse, _impl_.ret_val_),
};
...
CarrotFileResponse::CarrotFileResponse(const CarrotFileResponse& from)
  ...
  _this->_impl_.ret_val_ = from._impl_.ret_val_;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          _impl_.ret_val_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CarrotFileResponse::_InternalSerialize(
  ...
  // int32 ret_val = 2;
  if (this->_internal_ret_val() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(2, this->_internal_ret_val(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:CarrotFileResponse)
  ...
  // int32 ret_val = 2;
  if (this->_internal_ret_val() != 0) {
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_ret_val());
  }
...
void CarrotFileResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_ret_val() != 0) {
    _this->_internal_set_ret_val(from._internal_ret_val());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void CarrotFileResponse::InternalSwap(CarrotFileResponse* other) {
  ...
  swap(_impl_.ret_val_, other->_impl_.ret_val_);
}
